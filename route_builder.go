...
func (b *RouteBuilder) ReturnsError(code int, message string, model interface{}) *RouteBuilder {
	Print("ReturnsError is deprecated, use Returns instead.")
...
func (b *RouteBuilder) Build() Route {
	...
	if err != nil {
		Printf("[restful] Invalid path:%s because:%v", b.currentPath, err)
		os.Exit(1)
	}
	if b.function == nil {
		Printf("[restful] No function specified for route:" + b.currentPath)
		os.Exit(1)
	}
