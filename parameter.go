...
// DefaultValue sets the defaultValue field and return the receiver
func (p *Parameter) DefaultValue(queryDefaultValue string) *Parameter {
	p.data.DefaultValue = queryDefaultValue
	return p
}
